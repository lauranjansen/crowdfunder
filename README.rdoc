...
* Create reward framework
* Use Cocoon for adding rewards to projects
* Make pledges work
* Discuss authorization

* Add owner namespace if it makes sense

* Add categories

== README

Kickstarter clone in Ruby on Rails, first iteration.
...
#As a Backer, I want to be able to back a project at a certain reward should be able to click on a reward and have it submitted
with no page refresh once submitted, upon success, the amount raised should update
